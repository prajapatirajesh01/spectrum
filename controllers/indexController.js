...
const uprofile_get = async(req,res,next)=>{
  console.log('userdetailofaaa',req.user);
...
res.render('login',{'output':'Logged Out !!'}) 
  ...
  //--------------------- Export Start ------------------------------------------
export {uprofile_get, home , login , login_post , regitation , regitation_post , forgot , forgotpost, otp,otp_verify, resset, resetpost, index ,indexpost, about , games, blog, contactpage , privacypolicy , termscondition, dashboard,logout,uterm,uprivacy 
}
